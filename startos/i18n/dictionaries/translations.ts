...
export default {
  es_ES: {
    ...
    211: 'URL de dominio público',
    212: 'Usa esta URL para acceder a Push TX desde cualquier lugar a través de tu dominio público.',
    213: 'Usa esta URL para acceder a NFC Push TX a través de este servicio.',
  ...
  de_DE: {
    ...
    210: 'NFC Push TX URL',
    211: 'Öffentliche Domain-URL',
    212: 'Verwenden Sie diese URL, um von überall über Ihre öffentliche Domain auf Push TX zuzugreifen.',
    213: 'Verwenden Sie diese URL, um über diesen Dienst auf NFC Push TX zuzugreifen.',
    ...
    305: 'Hostname',
    306: 'RPC-Hostname für Ihren Bitcoin-Knoten.',
    307: 'Benutzername',
    308: 'RPC-Benutzername für Ihren Bitcoin-Knoten.',
    309: 'Passwort',
    310: 'RPC-Passwort für Ihren Bitcoin-Knoten.',
    311: 'Einstellungen',
    312: 'Bitcoin-Knoten-Einstellungen',
  ...
  pl_PL: {
    ...
    211: 'URL publicznej domeny',
    212: 'Użyj tego URL-a, aby uzyskać dostęp do Push TX z dowolnego miejsca przez swoją publiczną domenę.',
    213: 'Użyj tego URL-a, aby uzyskać dostęp do NFC Push TX przez ten serwis.',
  ...
  fr_FR: {
    ...
    210: 'URL NFC Push TX',
    211: 'URL de domaine public',
    212: "Utilisez cette URL pour accéder à Push TX depuis n'importe où via votre domaine public.",
    213: 'Utilisez cette URL pour accéder à NFC Push TX via ce service.',
